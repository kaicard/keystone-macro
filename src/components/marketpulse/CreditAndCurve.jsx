  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div className="glass rounded-xl p-5 flex flex-col justify-between">
        <h3 className="text-xs font-semibold uppercase tracking-wide text-muted-foreground mb-4">Dollar Index (DXY)</h3>
        {dxy ? (
          <div>
            <p className="text-3xl font-bold tracking-tight mb-1">{dxy.value}</p>
            <div className="flex items-center gap-2">
