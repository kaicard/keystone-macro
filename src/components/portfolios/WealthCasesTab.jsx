...
import { ArrowLeft, GraduationCap, Briefcase, Building2, Clock, Crown, Heart, Globe, Landmark } from 'lucide-react';
...
const cases = [
  {
    icon: GraduationCap, iconColor: 'text-cyan-400',
    title: 'Young Professional', subtitle: '£25,000 — Long-term accumulation', tag: 'Growth',
    ...
    proposed_saa: [{ asset_class: 'Global Equities', weight: 75 }, { asset_class: 'Emerging Markets', weight: 10 }, { asset_class: 'Fixed Income', weight: 5 }, { asset_class: 'Gold', weight: 5 }, { asset_class: 'Cash', weight: 5 }],
  ...
  },
  {
    ...
    title: 'Mid-Career Executive', subtitle: '£250,000 — Balanced growth', tag: 'Balanced',
    ...
    risk_tolerance: 'Medium', time_horizon: '12–15 years', investable_amount: '£250,000',
    liquidity_needs: 'Moderate — potential education-related withdrawal of £40-60k within 10 years',
    proposed_saa: [{ asset_class: 'Global Equities', weight: 55 }, { asset_class: 'Fixed Income', weight: 25 }, { asset_class: 'Alternatives', weight: 10 }, { asset_class: 'Gold', weight: 5 }, { asset_class: 'Cash', weight: 5 }],
  ...
  {
    icon: Building2, iconColor: 'text-amber-400',
    title: 'Entrepreneur Post-Exit', subtitle: '£2,000,000 — Capital preservation with growth', tag: 'Conservative Growth',
    ...
    proposed_saa: [{ asset_class: 'Fixed Income', weight: 35 }, { asset_class: 'Global Equities', weight: 30 }, { asset_class: 'Alternatives', weight: 15 }, { asset_class: 'Gold', weight: 10 }, { asset_class: 'Cash & Money Market', weight: 10 }],
  ...
  },
  {
    ...
    title: 'Pre-Retirement Planning', subtitle: '£500,000 — Transition to drawdown', tag: 'Income Focus',
    ...
    risk_tolerance: 'Low', time_horizon: '3 years to retirement, then 25+ years in drawdown', investable_amount: '£500,000',
    liquidity_needs: 'High — regular income drawdown of approximately £30k/year',
    proposed_saa: [{ asset_class: 'Fixed Income', weight: 45 }, { asset_class: 'Global Equities', weight: 25 }, { asset_class: 'Cash & Money Market', weight: 15 }, { asset_class: 'Gold', weight: 10 }, { asset_class: 'Alternatives', weight: 5 }],
  ...
  {
    icon: Crown, iconColor: 'text-purple-400',
    title: 'High Net Worth Family Office', subtitle: '£5,000,000+ — Multi-generational wealth', tag: 'Multi-Generational',
    ...
    risk_tolerance: 'Medium', time_horizon: '30+ years (multi-generational)', investable_amount: '£5,000,000+',
    liquidity_needs: 'Moderate — annual income drawdown of ~£150k; remainder long-term',
    proposed_saa: [{ asset_class: 'Global Equities', weight: 45 }, { asset_class: 'Private Assets / Alternatives', weight: 20 }, { asset_class: 'Fixed Income', weight: 15 }, { asset_class: 'Real Assets / Property', weight: 10 }, { asset_class: 'Gold', weight: 5 }, { asset_class: 'Cash', weight: 5 }],
    ...
    rationale: 'Multi-generational mandate justifies a higher allocation to private assets and alternatives — the illiquidity premium is accessible at this scale. Global equity provides the compounding engine. Fixed income and gold provide ballast and serve as a rebalancing source during equity drawdowns.',
    ...
    regime_changes: 'Inflationary environment strengthens real assets and commodities case. Higher rates reduce direct property valuations but improve fixed income entry points.',
  },
  {
    icon: Heart, iconColor: 'text-rose-400',
    title: 'Widow / Beneficiary', subtitle: '£400,000 — Financial independence', tag: 'Preservation',
    ...
    risk_tolerance: 'Low-Medium', time_horizon: '15–20 years', investable_amount: '£400,000',
    liquidity_needs: 'Moderate — potential home renovation spend of ~£30-50k within 2 years',
    proposed_saa: [{ asset_class: 'Fixed Income', weight: 35 }, { asset_class: 'Global Equities', weight: 30 }, { asset_class: 'Cash & Money Market', weight: 20 }, { asset_class: 'Gold', weight: 10 }, { asset_class: 'Alternatives', weight: 5 }],
    ...
    rationale: 'Simplicity and emotional resilience are paramount given low prior investment experience and emotional context. A conservative-to-balanced allocation is appropriate. High cash allocation ensures near-term capital availability without forced selling.',
    key_risks: 'Over-conservatism could fail to generate real returns over a 20-year horizon. Emotional decision-making following adverse market events. Potential for capital erosion through excessive fee drag.',
    ...
    behavioural_considerations: 'Building investment confidence is central to success. Regular, plain-language reporting on portfolio progress. Establish clear long-run objectives to anchor decisions during market volatility.',
    regime_changes: 'Persistent high inflation would erode purchasing power significantly over a 20-year horizon — should trigger an allocation review toward real assets.',
  },
  {
    icon: Globe, iconColor: 'text-teal-400',
    title: 'Internationally Mobile Professional', subtitle: '£180,000 — Multi-currency complexity', tag: 'Growth',
    ...
    constraints: 'Potential relocation within 5 years creates a shorter effective time horizon for UK-wrapper assets. Currency mismatch between GBP income and AUD long-term liabilities.',
    risk_tolerance: 'Medium-High', time_horizon: '5 years (UK), 20+ years (global)', investable_amount: '£180,000',
    liquidity_needs: 'Moderate — potential relocation costs and AUD conversion',
    proposed_saa: [{ asset_class: 'Global Equities (USD-denominated)', weight: 50 }, { asset_class: 'Fixed Income (short duration)', weight: 20 }, { asset_class: 'AUD-denominated Assets', weight: 15 }, { asset_class: 'Gold (USD)', weight: 10 }, { asset_class: 'Cash (multi-currency)', weight: 5 }],
    ...
    rationale: 'Currency complexity demands a deliberate approach. Denominating equity allocation in USD provides a natural hedge against both GBP and AUD long-term moves. Short-duration fixed income preserves capital in the near term and maintains flexibility for relocation costs.',
    key_risks: 'GBP appreciation vs AUD would reduce the sterling value of Australian-denominated assets. Relocation-triggered tax events may create unexpected liquidity needs.',
    ...
    behavioural_considerations: 'Simplify where possible to maintain oversight across borders. Avoid over-engineering the currency hedge — perfect is the enemy of good.',
  ...
  {
    icon: Landmark, iconColor: 'text-indigo-400',
    title: 'Defined Benefit Pension Recipient', subtitle: '£350,000 additional wealth — Low income need', tag: 'Preservation',
    ...
    risk_tolerance: 'Medium', time_horizon: '20+ years (estate planning horizon)', investable_amount: '£350,000',
    liquidity_needs: 'Low — no income requirement; occasional large purchases only',
    proposed_saa: [{ asset_class: 'Global Equities', weight: 55 }, { asset_class: 'Fixed Income', weight: 20 }, { asset_class: 'Alternatives', weight: 10 }, { asset_class: 'Gold', weight: 10 }, { asset_class: 'Cash', weight: 5 }],
    ...
    rationale: "The DB pension is the portfolio's most important asset — it provides a bond-like income floor that fundamentally changes the risk calculus. The investment portfolio can therefore be more growth-oriented than the investor's age would suggest.",
    key_risks: 'Longevity risk is low given DB pension security. Primary risk is inflation eroding the real value of the DB pension and portfolio over 25+ years.',
    ...
    behavioural_considerations: 'Risk of over-conservatism — investors with secure income often default to very defensive positioning that fails to preserve real wealth.',
    regime_changes: 'Higher inflation is the key risk — would require increasing real asset and commodity exposure.',
  },
];

function CaseDetail({ selected, onBack }) {
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      ...
      <div className="glass rounded-xl p-6 border border-primary/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div>
            <p className="text-xs text-muted-foreground font-semibold uppercase tracking-wide mb-2">TAA Adjustments</p>
...
export default function WealthCasesTab() {
  const [selected, setSelected] = useState(null);

  if (selected) {
    return <CaseDetail selected={selected} onBack={() => setSelected(null)} />;
  }

  return (
    <div>
      <p className="text-muted-foreground mb-6">Institutional-grade portfolio construction across a range of client mandates, objectives, and constraints.</p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {cases.map((c, i) => (
          <motion.div
            key={c.title}
