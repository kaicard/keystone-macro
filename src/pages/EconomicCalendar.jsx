...
const EVENTS = [
  ...
  // ── March 30 ──────────────────────────────────────────────────────────────
  { id: 39, date: '2026-03-30', utcTime: '11:00', country: 'DE', event: 'Germany CPI Preliminary (YoY)', importance: 'high', previous: '2.3%', forecast: '2.2%', actual: '2.2%', category: 'Inflation',
    outcome: 'German CPI came in at 2.2% YoY, in line with consensus and down from 2.3%. Energy deflation continues to pull the headline lower. EUR/USD was unmoved; reinforces ECB April cut expectations.' },
  ...
  { id: 41, date: '2026-03-30', utcTime: '23:30', country: 'JP', event: 'Tokyo CPI (YoY)', importance: 'medium', previous: '2.9%', forecast: '2.7%', actual: '2.4%', category: 'Inflation',
    outcome: 'Tokyo CPI came in softer at 2.4% YoY, below the 2.7% forecast. Services prices eased. A dovish signal for the BOJ — market reduced near-term rate hike bets; JPY weakened modestly.' },
  ...
  { id: 42, date: '2026-03-31', utcTime: '01:00', country: 'JP', event: 'Japan Tankan Large Mfg Index Q1', importance: 'high', previous: '14', forecast: '12', actual: '12', category: 'PMI',
    outcome: 'Tankan Large Manufacturing index fell to 12 as expected, reflecting yen strength pressures and soft external demand. Non-manufacturing held at 35. BOJ on hold; outlook guidance weakened.' },
  { id: 43, date: '2026-03-31', utcTime: '01:30', country: 'CN', event: 'China NBS Manufacturing PMI', importance: 'high', previous: '49.1', forecast: '49.8', actual: '50.5', category: 'PMI',
    outcome: 'China NBS Manufacturing PMI surged to 50.5, back into expansion and well above the 49.8 consensus. Largest one-month improvement in over a year. Production and new orders both expanded. Risk assets rallied on the open; commodity prices lifted.' },
  { id: 44, date: '2026-03-31', utcTime: '01:30', country: 'CN', event: 'China NBS Non-Manufacturing PMI', importance: 'medium', previous: '50.4', forecast: '50.6', actual: '50.8', category: 'PMI',
    outcome: 'Non-manufacturing PMI beat at 50.8. Services activity expanded solidly, supported by domestic consumption stimulus. Composite PMI rose to 51.4.' },
  { id: 45, date: '2026-03-31', utcTime: '06:00', country: 'DE', event: 'Germany Retail Sales (MoM)', importance: 'medium', previous: '-0.9%', forecast: '0.3%', actual: '0.8%', category: 'Consumer',
    outcome: 'German retail sales beat strongly at +0.8% MoM, reversing most of the prior month\'s decline. Consumer spending showing signs of resilience despite ongoing macro headwinds.' },
  { id: 46, date: '2026-03-31', utcTime: '06:00', country: 'UK', event: 'UK GDP Q4 Final (QoQ)', importance: 'medium', previous: '0.1%', forecast: '0.1%', actual: '0.1%', category: 'GDP',
    outcome: 'UK Q4 GDP confirmed at +0.1% QoQ, in line with expectations. No revision to the preliminary estimate. Annual growth of 1.4%. Little market reaction on the confirmation.' },
  { id: 12, date: '2026-03-31', utcTime: '09:00', country: 'EU', event: 'Eurozone CPI Flash (YoY)', importance: 'high', previous: '2.3%', forecast: '2.2%', actual: '2.2%', category: 'Inflation',
    outcome: 'Eurozone flash CPI came in at 2.2% YoY, in line with consensus. Energy prices dragged the headline down. Services inflation eased to 3.4%. EUR/USD dipped modestly; ECB April cut fully priced.' },
  { id: 13, date: '2026-03-31', utcTime: '09:00', country: 'EU', event: 'Eurozone Core CPI Flash (YoY)', importance: 'high', previous: '2.6%', forecast: '2.5%', actual: '2.4%', category: 'Inflation',
    outcome: 'Core CPI surprised to the downside at 2.4%, below the 2.5% forecast. Meaningful progress toward the ECB\'s 2% target. EUR weakened on the beat; rate cut probabilities for April firmed to ~90%.' },

  // ── April 1 ───────────────────────────────────────────────────────────────
  { id: 47, date: '2026-04-01', utcTime: '01:45', country: 'CN', event: 'China Caixin Manufacturing PMI', importance: 'medium', previous: '50.8', forecast: '50.5', actual: '51.2', category: 'PMI',
    outcome: 'Caixin Manufacturing PMI beat expectations at 51.2, up from 50.8 prior. New orders and output both expanded. Positive surprise against a backdrop of trade uncertainty. CNH strengthened modestly.' },
  { id: 48, date: '2026-04-01', utcTime: '07:00', country: 'EU', event: 'Eurozone Manufacturing PMI Final', importance: 'medium', previous: '47.6', forecast: '48.7', actual: '48.6', category: 'PMI',
    outcome: 'Eurozone manufacturing PMI confirmed at 48.6 in the final reading, marginally below flash estimate of 48.7 but a clear improvement from 47.6. Contraction easing across most member states. EUR/USD largely unmoved on the confirmation.' },
  { id: 14, date: '2026-04-01', utcTime: '08:30', country: 'UK', event: 'UK Manufacturing PMI Final', importance: 'medium', previous: '46.9', forecast: '47.2', actual: '44.9', category: 'PMI',
    outcome: 'UK Manufacturing PMI was revised sharply lower to 44.9 in the final reading, well below the flash 47.2 estimate. Steepest contraction since early 2023. Output and new orders both fell sharply. Sterling fell ~40 pips on the release; BOE cut expectations firmed.' },
  { id: 49, date: '2026-04-01', utcTime: '12:15', country: 'US', event: 'ADP Non-Farm Employment Change', importance: 'high', previous: '77K', forecast: '118K', actual: '62K', category: 'Labour',
    outcome: 'ADP payrolls badly missed at just 62K, far below the 118K consensus and the weakest reading since mid-2023. Manufacturing and leisure & hospitality shed jobs. A stagflationary signal ahead of Friday\'s NFP. USD sold off sharply; Treasury yields fell.' },
  { id: 15, date: '2026-04-01', utcTime: '14:00', country: 'US', event: 'ISM Manufacturing PMI', importance: 'high', previous: '50.3', forecast: '49.5', actual: null, category: 'PMI', outcome: null },
