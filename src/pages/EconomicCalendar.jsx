...
// All times stored as UTC (HH:MM). "All Day" and "—" are passed through as-is.
const EVENTS = [
  // March 17 — US times ET (UTC-5 in March)
  ...
  // March 20 — UK GMT (UTC+0), CH CET (UTC+1)
  { id: 106, date: '2026-03-20', utcTime: '12:00', country: 'UK', event: 'BOE Interest Rate Decision',      importance: 'high',   previous: '4.50%', forecast: '4.50%', actual: '4.50%', category: 'Central Bank',
  ...
  { id: 107, date: '2026-03-20', utcTime: '06:45', country: 'CH', event: 'SNB Interest Rate Decision',      importance: 'high',   previous: '0.50%', forecast: '0.25%', actual: '0.25%', category: 'Central Bank',
  ...
  // March 24 — UK GMT (UTC+0), EU CET (UTC+1), US ET (UTC-5)
  ...
  // March 25 — US ET (UTC-5), DE CET (UTC+1)
  ...
  // March 26 — UK GMT (UTC+0), EU CET (UTC+1), US ET (UTC-5)
  ...
  // March 27 — DE CET (UTC+1), UK GMT (UTC+0), US ET (UTC-5)
  ...
  { id: 9,  date: '2026-03-27', utcTime: '20:00', country: 'US', event: 'University of Michigan Sentiment (Final)', importance: 'medium', previous: '57.9', forecast: '57.9', actual: null, category: 'Consumer',
    outcome: null },

  // March 28 — Good Friday
  { id: 10, date: '2026-03-28', utcTime: 'All Day', country: 'US', event: 'Good Friday — US & UK Markets Closed', importance: 'high', previous: '—', forecast: '—', actual: null, category: 'Holiday',
    outcome: null },
  { id: 11, date: '2026-03-28', utcTime: '17:30', country: 'US', event: 'Core PCE Price Index (MoM) — Feb', importance: 'high', previous: '0.3%', forecast: '0.3%', actual: null, category: 'Inflation',
  ...
  // March 30 — US ET (UTC-5), Powell speaks at 11:25 ET = 16:25 UTC
  { id: 39, date: '2026-03-30', utcTime: '16:25', country: 'US', event: 'Fed Chair Powell Speech',  importance: 'high', previous: '—', forecast: '—', actual: null, category: 'Central Bank',
    outcome: null },

  // March 31 — EU CET (UTC+1) → BST now (UK BST = UTC+1 from Mar 29)
  { id: 12, date: '2026-03-31', utcTime: '09:00', country: 'EU', event: 'Eurozone CPI Flash (YoY)',        importance: 'high',   previous: '2.3%',  forecast: '2.2%',  actual: null,    category: 'Inflation',
    outcome: null },
  { id: 13, date: '2026-03-31', utcTime: '09:00', country: 'EU', event: 'Eurozone Core CPI Flash (YoY)',   importance: 'high',   previous: '2.6%',  forecast: '2.5%',  actual: null,    category: 'Inflation',
    outcome: null },

  // April 1 — UK BST (UTC+1), US EDT (UTC-4)
  { id: 14, date: '2026-04-01', utcTime: '08:30', country: 'UK', event: 'UK Manufacturing PMI Final',      importance: 'medium', previous: '46.9',  forecast: '47.2',  actual: null,    category: 'PMI',
    outcome: null },
  { id: 15, date: '2026-04-01', utcTime: '14:00', country: 'US', event: 'ISM Manufacturing PMI',           importance: 'high',   previous: '50.3',  forecast: '49.8',  actual: null,    category: 'PMI',
    outcome: null },

  // April 2 — EU CEST (UTC+2), US EDT (UTC-4)
  { id: 16, date: '2026-04-02', utcTime: '07:00', country: 'EU', event: 'Eurozone Services PMI Final',     importance: 'medium', previous: '50.6',  forecast: '50.6',  actual: null,    category: 'PMI',
    outcome: null },
  { id: 17, date: '2026-04-02', utcTime: '14:00', country: 'US', event: 'ISM Services PMI',               importance: 'high',   previous: '53.5',  forecast: '53.0',  actual: null,    category: 'PMI',
    outcome: null },
  { id: 18, date: '2026-04-02', utcTime: '14:00', country: 'US', event: 'JOLTS Job Openings',              importance: 'medium', previous: '7.74M', forecast: '7.60M', actual: null,    category: 'Labour',
    outcome: null },

  // April 3 — US EDT (UTC-4), CA EDT (UTC-4)
  { id: 19, date: '2026-04-03', utcTime: '12:30', country: 'US', event: 'Non-Farm Payrolls (NFP)',         importance: 'high',   previous: '151K',  forecast: '140K',  actual: null,    category: 'Labour',
    outcome: null },
  { id: 20, date: '2026-04-03', utcTime: '12:30', country: 'US', event: 'Unemployment Rate',              importance: 'high',   previous: '4.1%',  forecast: '4.1%',  actual: null,    category: 'Labour',
    outcome: null },
  { id: 21, date: '2026-04-03', utcTime: '12:30', country: 'US', event: 'Average Hourly Earnings (MoM)', importance: 'medium', previous: '0.3%',  forecast: '0.3%',  actual: null,    category: 'Labour',
    outcome: null },
  { id: 22, date: '2026-04-03', utcTime: '12:30', country: 'CA', event: 'Canada Employment Change',       importance: 'medium', previous: '1.1K',  forecast: '10.0K', actual: null,    category: 'Labour',
    outcome: null },

  // April 7 — RBA AEDT (UTC+11) → 04:30 AEDT = 17:30 UTC prev day; released Mon morning AU = Sun 17:30 UTC
  { id: 23, date: '2026-04-07', utcTime: '03:30', country: 'AU', event: 'RBA Interest Rate Decision',     importance: 'high',   previous: '4.10%', forecast: '4.10%', actual: null,    category: 'Central Bank',
    outcome: null },

  // April 9 — UK BST (UTC+1)
  { id: 24, date: '2026-04-09', utcTime: '11:00', country: 'UK', event: 'BOE Interest Rate Decision',     importance: 'high',   previous: '4.50%', forecast: '4.25%', actual: null,    category: 'Central Bank',
    outcome: null },
  { id: 25, date: '2026-04-09', utcTime: '11:30', country: 'UK', event: 'BOE MPC Minutes & Press Conference', importance: 'high', previous: '—',    forecast: '—',     actual: null,    category: 'Central Bank',
    outcome: null },

  // April 10 — US EDT (UTC-4)
  { id: 26, date: '2026-04-10', utcTime: '12:30', country: 'US', event: 'US CPI (YoY)',                   importance: 'high',   previous: '2.8%',  forecast: '2.6%',  actual: null,    category: 'Inflation',
    outcome: null },
  { id: 27, date: '2026-04-10', utcTime: '12:30', country: 'US', event: 'US Core CPI (YoY)',              importance: 'high',   previous: '3.1%',  forecast: '3.0%',  actual: null,    category: 'Inflation',
    outcome: null },

  // April 14 — US EDT (UTC-4)
  { id: 28, date: '2026-04-14', utcTime: '12:30', country: 'US', event: 'US Retail Sales (MoM)',          importance: 'high',   previous: '-0.9%', forecast: '0.6%',  actual: null,    category: 'Consumer',
    outcome: null },

  // April 16 — US EDT (UTC-4)
  { id: 29, date: '2026-04-16', utcTime: '12:30', country: 'US', event: 'US Housing Starts',              importance: 'medium', previous: '1.37M', forecast: '1.39M', actual: null,    category: 'Housing',
    outcome: null },

  // April 17 — EU CEST (UTC+2)
  { id: 30, date: '2026-04-17', utcTime: '12:15', country: 'EU', event: 'ECB Interest Rate Decision',     importance: 'high',   previous: '2.65%', forecast: '2.40%', actual: null,    category: 'Central Bank',
    outcome: null },
  { id: 31, date: '2026-04-17', utcTime: '12:45', country: 'EU', event: 'ECB Press Conference',           importance: 'high',   previous: '—',     forecast: '—',     actual: null,    category: 'Central Bank',
    outcome: null },

  // April 23 — UK BST (UTC+1), EU CEST (UTC+2), US EDT (UTC-4)
  { id: 32, date: '2026-04-23', utcTime: '08:30', country: 'UK', event: 'UK PMI Composite Flash',         importance: 'medium', previous: '50.5',  forecast: '50.3',  actual: null,    category: 'PMI',
    outcome: null },
  { id: 33, date: '2026-04-23', utcTime: '08:00', country: 'EU', event: 'Eurozone PMI Composite Flash',   importance: 'high',   previous: '50.2',  forecast: '50.5',  actual: null,    category: 'PMI',
    outcome: null },
  { id: 34, date: '2026-04-23', utcTime: '13:45', country: 'US', event: 'S&P Global US PMI Composite Flash', importance: 'medium', previous: '53.5', forecast: '52.8', actual: null,   category: 'PMI',
    outcome: null },

  // April 25 — US EDT (UTC-4)
  { id: 35, date: '2026-04-25', utcTime: '12:30', country: 'US', event: 'US GDP Q1 Advance (QoQ Ann.)',   importance: 'high',   previous: '2.4%',  forecast: '1.5%',  actual: null,    category: 'GDP',
    outcome: null },
  { id: 36, date: '2026-04-25', utcTime: '12:30', country: 'US', event: 'Core PCE Price Index (MoM) — Mar', importance: 'high', previous: '0.4%',  forecast: '0.3%',  actual: null,    category: 'Inflation',
    outcome: null },

  // April 29-30 — US EDT (UTC-4)
  { id: 37, date: '2026-04-29', utcTime: '18:00', country: 'US', event: 'FOMC Interest Rate Decision',    importance: 'high',   previous: '4.25–4.50%', forecast: '4.25–4.50%', actual: null, category: 'Central Bank',
    outcome: null },
  { id: 38, date: '2026-04-30', utcTime: '18:30', country: 'US', event: 'FOMC Press Conference',          importance: 'high',   previous: '—',     forecast: '—',     actual: null,    category: 'Central Bank',
    outcome: null },
];
...
// Convert a stored UTC time string ("HH:MM") + date to the user's local time
    ...
    <div className={`border-b border-border/20 last:border-0 ${isToday && isHigh ? 'bg-primary/3' : ''}`}>
      ...
      >
        <div className="flex items-center gap-4">
          {/* Time — converted to viewer's local timezone */}
