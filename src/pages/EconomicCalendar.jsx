...
const EVENTS = [
  ...
  { id: 9, date: '2026-03-27', utcTime: '20:00', country: 'US', event: 'University of Michigan Sentiment (Final)', importance: 'medium', previous: '57.9', forecast: '57.9', actual: null, category: 'Consumer', outcome: null },
  ...
  { id: 11, date: '2026-03-28', utcTime: '17:30', country: 'US', event: 'Core PCE Price Index (MoM) — Feb', importance: 'high', previous: '0.3%', forecast: '0.3%', actual: null, category: 'Inflation',
    outcome: 'Note: Released Good Friday. Markets closed; reaction deferred to Monday. Consensus 0.3% MoM, YoY holding at 2.8%.' },

  // ── March 30 ──────────────────────────────────────────────────────────────
  { id: 39, date: '2026-03-30', utcTime: '11:00', country: 'DE', event: 'Germany CPI Preliminary (YoY)', importance: 'high', previous: '2.3%', forecast: '2.2%', actual: null, category: 'Inflation', outcome: null },
  { id: 40, date: '2026-03-30', utcTime: '16:25', country: 'US', event: 'Fed Chair Powell Speech', importance: 'high', previous: '—', forecast: '—', actual: null, category: 'Central Bank', outcome: null },
  { id: 41, date: '2026-03-30', utcTime: '23:30', country: 'JP', event: 'Tokyo CPI (YoY)', importance: 'medium', previous: '2.9%', forecast: '2.7%', actual: null, category: 'Inflation', outcome: null },

  // ── March 31 ──────────────────────────────────────────────────────────────
  { id: 42, date: '2026-03-31', utcTime: '01:00', country: 'JP', event: 'Japan Tankan Large Mfg Index Q1', importance: 'high', previous: '14', forecast: '12', actual: null, category: 'PMI', outcome: null },
  { id: 43, date: '2026-03-31', utcTime: '01:30', country: 'CN', event: 'China NBS Manufacturing PMI', importance: 'high', previous: '49.1', forecast: '49.8', actual: null, category: 'PMI', outcome: null },
  { id: 44, date: '2026-03-31', utcTime: '01:30', country: 'CN', event: 'China NBS Non-Manufacturing PMI', importance: 'medium', previous: '50.4', forecast: '50.6', actual: null, category: 'PMI', outcome: null },
  { id: 45, date: '2026-03-31', utcTime: '06:00', country: 'DE', event: 'Germany Retail Sales (MoM)', importance: 'medium', previous: '-0.9%', forecast: '0.3%', actual: null, category: 'Consumer', outcome: null },
  { id: 46, date: '2026-03-31', utcTime: '06:00', country: 'UK', event: 'UK GDP Q4 Final (QoQ)', importance: 'medium', previous: '0.1%', forecast: '0.1%', actual: null, category: 'GDP', outcome: null },
  { id: 12, date: '2026-03-31', utcTime: '09:00', country: 'EU', event: 'Eurozone CPI Flash (YoY)', importance: 'high', previous: '2.3%', forecast: '2.2%', actual: null, category: 'Inflation', outcome: null },
  { id: 13, date: '2026-03-31', utcTime: '09:00', country: 'EU', event: 'Eurozone Core CPI Flash (YoY)', importance: 'high', previous: '2.6%', forecast: '2.5%', actual: null, category: 'Inflation', outcome: null },

  // ── April 1 ───────────────────────────────────────────────────────────────
  { id: 47, date: '2026-04-01', utcTime: '01:45', country: 'CN', event: 'China Caixin Manufacturing PMI', importance: 'medium', previous: '50.8', forecast: '50.5', actual: null, category: 'PMI', outcome: null },
  { id: 48, date: '2026-04-01', utcTime: '07:00', country: 'EU', event: 'Eurozone Manufacturing PMI Final', importance: 'medium', previous: '47.6', forecast: '48.7', actual: null, category: 'PMI', outcome: null },
  { id: 14, date: '2026-04-01', utcTime: '08:30', country: 'UK', event: 'UK Manufacturing PMI Final', importance: 'medium', previous: '46.9', forecast: '47.2', actual: null, category: 'PMI', outcome: null },
  { id: 49, date: '2026-04-01', utcTime: '12:15', country: 'US', event: 'ADP Non-Farm Employment Change', importance: 'high', previous: '77K', forecast: '118K', actual: null, category: 'Labour', outcome: null },
