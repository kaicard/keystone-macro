...
const SEED_EVENTS = [
  { id: 's1',  date: '2026-03-19', utcTime: '18:00', country: 'US', event: 'FOMC Interest Rate Decision', importance: 'high', previous: '3.75–4.00%', forecast: '3.50–3.75%', actual: '3.50–3.75%', category: 'Central Bank', outcome: 'Fed cut 25bp to 3.50–3.75% as expected. Dot plot showed one more cut in 2026, down from two. GDP forecasts trimmed; PCE inflation upgraded. Powell flagged tariff and geopolitical uncertainty. Equities dipped; 10-year yields rose 4bp.' },
  { id: 's2',  date: '2026-03-20', utcTime: '12:00', country: 'UK', event: 'BOE Interest Rate Decision', importance: 'high', previous: '4.00%', forecast: '3.75%', actual: '3.75%', category: 'Central Bank', outcome: 'BOE held at 3.75% unanimously. MPC cited energy price spike as upside inflation risk, overriding the near-term case for a cut. Two members had considered a 25bp cut but voted to hold. GBP firmed.' },
  { id: 's3',  date: '2026-03-31', utcTime: '09:00', country: 'EU', event: 'Eurozone Core CPI Flash (YoY)', importance: 'high', previous: '2.6%', forecast: '2.5%', actual: '2.4%', category: 'Inflation', outcome: 'Eurozone core CPI fell to 2.4%, below both the 2.5% forecast and 2.6% prior. Services inflation dropped to 3.4%. ECB April cut expectations firmed to ~95%. EUR/USD slipped 0.3%.' },
  ...
  { id: 's5',  date: '2026-04-03', utcTime: '12:30', country: 'US', event: 'Nonfarm Payrolls', importance: 'high', previous: '151K', forecast: '138K', actual: '177K', category: 'Labour', outcome: 'NFP beat at 177K versus 138K forecast. Unemployment held at 4.2%. Average hourly earnings +0.3% MoM. A resilient but softening labour market signal. USD firmed initially before fading on tariff concerns.' },
  { id: 's6',  date: '2026-04-03', utcTime: '12:30', country: 'US', event: 'Unemployment Rate', importance: 'high', previous: '4.1%', forecast: '4.1%', actual: '4.2%', category: 'Labour', outcome: 'Unemployment edged up to 4.2%, above the 4.1% prior and forecast. Labour market softening gradually. Participation rate held steady at 62.5%.' },
  { id: 's7',  date: '2026-04-09', utcTime: '11:00', country: 'UK', event: 'BOE Interest Rate Decision', importance: 'high', previous: '3.75%', forecast: '3.50%', actual: '3.50%', category: 'Central Bank', outcome: 'BOE cut 25bp to 3.50% as expected, voting 7-2. Governor Bailey noted inflation on track but flagged tariff uncertainty as a near-term growth headwind. GBP fell 0.4% on the dovish tone; gilts rallied.' },
  { id: 's8',  date: '2026-04-10', utcTime: '12:30', country: 'US', event: 'US CPI (YoY)', importance: 'high', previous: '3.0%', forecast: '2.6%', actual: '2.4%', category: 'Inflation', outcome: 'US CPI surprised to the downside at 2.4% YoY in March, below both the 2.6% consensus and 3.0% prior. Core CPI fell to 2.8%. USD weakened sharply; June Fed cut expectations surged to 85%. 10-year yields dropped 12bp.' },
  { id: 's9',  date: '2026-04-10', utcTime: '12:30', country: 'US', event: 'US Core CPI (MoM)', importance: 'high', previous: '0.4%', forecast: '0.3%', actual: '0.1%', category: 'Inflation', outcome: 'Core CPI MoM came in at just 0.1%, the softest reading since 2021. Services inflation fell sharply. Confirmed disinflationary trend. Markets moved to price two Fed cuts by year-end.' },
  { id: 's10', date: '2026-04-17', utcTime: '12:15', country: 'EU', event: 'ECB Interest Rate Decision', importance: 'high', previous: '2.65%', forecast: '2.40%', actual: '2.40%', category: 'Central Bank', outcome: 'ECB cut 25bp to 2.40% as expected. Lagarde noted disinflation well on track and flagged tariff risks as downside growth concern. EUR/USD fell 0.2%; peripheral spreads tightened on easing signal.' },
  { id: 's11', date: '2026-04-29', utcTime: '12:30', country: 'US', event: 'GDP Advance Q1 (QoQ Ann.)', importance: 'high', previous: '2.4%', forecast: '0.4%', actual: '-0.3%', category: 'GDP', outcome: 'US GDP contracted 0.3% annualised in Q1, a significant miss versus the 0.4% forecast. Tariff-related import surge distorted trade component. Consumer spending held at 1.8%. Recession fears spiked; USD fell sharply.' },
  { id: 's12', date: '2026-04-29', utcTime: '18:00', country: 'US', event: 'FOMC Interest Rate Decision', importance: 'high', previous: '3.50–3.75%', forecast: '3.50–3.75%', actual: '3.50–3.75%', category: 'Central Bank', outcome: 'Fed held rates at 3.50–3.75% as expected. Statement flagged elevated uncertainty on both inflation and growth. Powell noted the Fed was monitoring tariff pass-through carefully. Markets repriced to three cuts in 2026.' },
];
