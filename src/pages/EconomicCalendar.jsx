...
const EVENTS = [
  ...
  { id: 49, date: '2026-04-01', utcTime: '12:15', country: 'US', event: 'ADP Non-Farm Employment Change', importance: 'high', previous: '77K', forecast: '105K', actual: '62K', category: 'Labour',
    outcome: 'ADP payrolls came in at 62K in March, missing the ~105K consensus and down from a revised 77K in February. Small employers drove job growth for a second month. Trade, transportation & utilities continued to decline. A soft pre-NFP signal; USD dipped on the miss.' },
