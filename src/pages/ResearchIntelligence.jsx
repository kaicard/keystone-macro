  ...
  return (
    <div className="pt-24 pb-20 min-h-screen relative">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <Link to="/Research" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground mb-10"><ArrowLeft className="w-4 h-4" />Research intelligence</Link>
        ...
        {item.source_url ? (
          <a href={item.source_url} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between gap-4 rounded-xl border border-primary/20 bg-primary/5 p-4 mb-8 hover:bg-primary/10 transition-colors">
          ...
          <div className="flex gap-3 rounded-xl border border-amber-400/20 bg-amber-400/5 p-4 mb-8"><AlertTriangle className="w-4 h-4 text-amber-400 shrink-0 mt-0.5" /><p className="text-sm text-muted-foreground">This legacy item predates source-link requirements. Treat it as unverified commentary.</p></div>
        )}

        <div className="space-y-5">
          {item.impact && <section className="glass rounded-2xl p-6"><h2 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-3">Market impact</h2><p className="leading-relaxed text-foreground/85">{item.impact}</p></section>}
          {item.desk_view && <section className="glass rounded-2xl p-6"><h2 className="text-xs font-bold uppercase tracking-widest text-primary mb-3">Keystone view</h2><p className="leading-relaxed text-foreground/85">{item.desk_view}</p></section>}
          {item.what_to_watch && <section className="glass rounded-2xl p-6"><h2 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-3">What to watch</h2><p className="leading-relaxed text-foreground/85">{item.what_to_watch}</p></section>}
        </div>
