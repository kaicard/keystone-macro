...
const PREMIUM_FEATURES = [
  ...
  { icon: Globe, label: 'Referenced intelligence', desc: 'Direct attribution on new intelligence items.' },
  ...
  return (
    <div className="pt-24 lg:pt-28 pb-24 min-h-screen relative">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.header initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center pb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-primary/[0.07] border border-primary/15 mb-5"><Mail className="w-3.5 h-3.5 text-primary" /><span className="text-xs font-medium text-primary">Macro research · Delivered</span></div>
          <h1 className="font-display text-4xl sm:text-5xl font-semibold mb-4">The Macro Brief</h1>
        ...
        <div className="rounded-xl border border-primary/25 bg-card/70 p-6 sm:p-8 mb-5 relative overflow-hidden" data-premium-tier>
          <div className="absolute top-0 inset-x-0 h-px bg-primary/70" />
        ...
        <section className="rounded-xl border border-border/55 bg-card/45 p-6 sm:p-8 mb-5">
